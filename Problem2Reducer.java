 ...
 * Reducer program to find the number of ratings received by each movie
 ...
 * */
package mapreduce.assignment4.problem2;
...
public class Problem2Reducer extends Reducer<Text, IntWritable, Text, IntWritable>{
	public void reduce(Text key, Iterable<IntWritable> value, Context context) throws IOException, InterruptedException {
		//will add mapper output value to get the number of ratings received by each movie
		int Sum = 0; 
